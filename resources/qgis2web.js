...
var map = new ol.Map({
    ...
    layers: layersList,
    view: new ol.View({
        extent: [-10024830.381445, 4196989.552452, -9986578.579332, 4227740.260846], maxZoom: 28, minZoom: 11
    })
});


map.getView().fit([-10024830.381445, 4196989.552452, -9986578.579332, 4227740.260846], map.getSize());
